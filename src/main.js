        ...
        if(this._validateKeysExist(objectToAdd)) {
            try{
                ...
                if (cartToBeUpdated) {
                    ...
                    if(cartToBeUpdated.products == undefined) {
                        cartToBeUpdated.products = [];
                    }
                    cartToBeUpdated.products.push(objectToAdd);
                    await fs.promises.writeFile(this._filename, JSON.stringify(cartToBeUpdated));
                    return true;
                } else {
                console.log(`ID ${id} does not exist in the file`);
                return null;
